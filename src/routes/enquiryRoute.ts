...
enquiryRoute.get("/api/enquiry/list-enquiry-of-customer-by-venderId",verifyToken,listEnquiryUsingVenderId);
enquiryRoute.get("/api/enquiry/list-enquiry-category",listCategoryForEnquiry);
